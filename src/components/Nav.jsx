        ...
        <div className='px-9 border-[1px] border-gray-300'>
            <ul className='flex text-sm items-center justify-end text-[#757575] '>
                ...
                <li >
                    ...
                    <span className='absolute bottom-6 right-1 bg-red-500 text-white rounded-full w-[14px] h-[14px] text-center text-[10px] leading-[14px]'>{cart? cart.length : 0}</span>
                    </p>
                </li>
                <li >
                ...
                <div>
                    <ul className='flex items-center justify-center font-light text-xl text-[#111]'>
                        <li className='h-12  mx-4 cursor-pointer'>
                            <Link to="/" className={active===0?'h-full leading-[48px] nav-hover active':'h-full leading-[48px] nav-hover'} onClick={()=>handleActive(0)}>In Stock</Link>
                        </li>
                        <li  className='h-12  mx-4 cursor-pointer'><Link to="/in-stock" className={active===1?'h-full leading-[48px] nav-hover active':'h-full leading-[48px] nav-hover'} onClick={()=>handleActive(1)}>Feed</Link></li>
